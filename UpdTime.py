...
class UpdTime:
    ...
    def get(self):
        ...
        while True:
            ...
            minor_query = urllib.request.Request(minor_request, headers=headers)
            minor_xml = et.fromstring(urllib.request.urlopen(minor_query).read())
            # print minor_request
            ...
            major_query = urllib.request.Request(major_request, headers=headers)
            major_xml = et.fromstring(urllib.request.urlopen(major_query).read())
        ...
        return {'minor': minor_time, 'major': major_time}
